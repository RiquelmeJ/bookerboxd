...
function Bookinfo() {
    return (
        <div id="bookinfo">
            <div id="book-id">
                <h3 id="book-series">As Crônicas de Gelo e Fogo #1</h3>
                <h1 id="book-title">A Guerra dos Tronos</h1>
                <h2 id="book-author">George R. R. Martin </h2>
            </div>
            <h3>Sinopse</h3>
            ...
            <p><b>Gênero: </b>{"Aventura, Fantasia, Romance"}</p>
            <hr />
            <h3>Sobre o Autor</h3>
